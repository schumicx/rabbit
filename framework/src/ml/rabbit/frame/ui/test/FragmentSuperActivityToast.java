...
public class FragmentSuperActivityToast extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		final View view = inflater.inflate(
				R.layout.test_superactivitytoast_fragment, container, false);
		...
		mBackgroundSpinner = (Spinner) view
				.findViewById(R.id.backgroundSpinner);
	...
	private void showSuperToast() {
		...
		case R.id.hprogress_radiobutton:
			...
			/**
			 * Since this SuperActivityToast will show actual progress from a
			 * background ASyncTask the duration of the SuperActivityToast must
			 * be indeterminate
			 **/
