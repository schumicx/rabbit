...
public class FragmentSuperCardToast extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		final View view = inflater.inflate(R.layout.test_supercardtoast_fragment,
				container, false);
	...
	private void showSuperCardToast() {
		...
		case R.id.hprogress_radiobutton:
			...
			/**
			 * Since this SuperCardToast will show actual progress from a
			 * background ASyncTask the duration of the SuperCardToast must be
			 * indeterminate
			 **/
		...
		case 1:
			...
			/*
			 * No need to check Android version for this call. The library does
			 * this automatically. *
			 */
		...
		if (mImageCheckBox.isChecked()) {
			...
			superCardToast.setIcon(SuperToast.Icon.Dark.INFO,
	...
	private OnDismissWrapper onDismissWrapper = new OnDismissWrapper(
