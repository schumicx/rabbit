 ...
 *
 */
package ml.rabbit.frame.support.inscription;
...
public class ChangeLogDialog {
    ...
    protected void show(final int version) {
        ...
        //Get dialog title	        	
        String title = resources.getString(R.string.inscription_title_changelog);
        ...
        //Get button strings
        final String closeString = resources.getString(R.string.inscription_changelog_close);
